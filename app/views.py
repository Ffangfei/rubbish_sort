...
def index(page=1):
    ...
    messages = Punish.query.filter_by(to_user=current_user.username).order_by(db.desc(Punish.time)).paginate(page, 3,
                                                                                                             False)
...
def write():
    ...
    if form.validate_on_submit():
        post = Rubbish(type=form.type.data, weight=form.weight.data, community=form.community.data,
